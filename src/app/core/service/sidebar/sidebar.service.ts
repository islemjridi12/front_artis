          ...
          subRoutes: [
            {
              ...
              hasSubRoute: false,
              showSubRoute: false,
              route: 'https://dreamspos.dreamstechnologies.com/documentation/index.html',
              subRoutes: [],
              customSubmenuTwo: false,
            },
            {
              tittle: 'Changelog 2.2.5',
              hasSubRoute: false,
              showSubRoute: false,
              route: 'https://dreamspos.dreamstechnologies.com/documentation/changelog.html',
              subRoutes: [],
              customSubmenuTwo: false,
            },
            {
